#|
 ...
 |
 | Description: This file contains the the different game types - PvP, PvE, and 
 |   EvE. These functions drive the individual games, each of which requires 
 |   different interactions with the user.
 |#
